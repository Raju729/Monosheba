        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{url('admin/show-Psychiatrict')}}">Psychiatrict-details</a></li>
                    <li class="active">Edit Psychiatrict</li>
                </ol>
            </section>
            ...
            <section class="content">
                <div class="row">
                    <!-- right column -->
                    <form class="form-horizontal" id="psy_form" method="post" action="{{url('admin/update-Psychiatrict'.'/'.$psychiatric->id)}}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-info">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Edit Psychiatrict Information</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="city" id="city" class="form-control select2" style="width: 100%;">
                                                <option value="{{$psychiatric->city}}">{{$psychiatric->city}}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="name" value="{{$psychiatric->name}}" name="name">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="phone_no" value="{{$psychiatric->phone_no}}" name="phone_no">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="speciality" value="{{$psychiatric->speciality}}" name="speciality">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="designation" value="{{$psychiatric->designation}}" name="designation">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="joblocation" value="{{$psychiatric->joblocation}}" name="joblocation">
        ...
        $(document).ready(function() {
            ...
            function check_name() {
                if ($('#name').val() == '') {
                    ...
                    if (!nameformet.test($('#name').val())) {
                        $('#err_name').html("Invalid  name !!  Numeric value not support");
                        $('#err_name').show();
                    }
                    else {
